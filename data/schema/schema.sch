...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   ...
   <!-- This file generated 2026-01-01T18:48:33Z by 'extract-isosch.xsl'. -->
   <!-- ********************* -->
   <!-- namespaces, declared: -->
   <!-- ********************* -->
   ...
   <!-- ******************************************************* -->
   <!-- constraints in en, und, mul, zxx, of which there are 15 -->
   <!-- ******************************************************* -->
   ...
   <pattern id="schematron-constraint-mh-noQuotesInText-6">
   ...
   <pattern id="schematron-constraint-mh-noBadImageFilenames-7">
      <rule context="xh:img">
         <assert test="matches(@src, '^[a-zA-Z0-9/\._\-]+$')"> Image file paths must be well-formed (no spaces or punctuation).</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-mh-spacesAfterPeriods-8">
   ...
   <pattern id="schematron-constraint-mh-noSpacedPeriodEllipses-9">
      <rule context="xh:*[not(self::xh:code or self::xh:pre)][text()]">
   ...
   <pattern id="schematron-constraint-mh-noSpacesInHrefs-10">
      <rule context="xh:a">
         <assert test="not(matches(@href, '\s+'))"> There should be no spaces in href attributes (links).</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-mh-noLinksInLinks-11">
      <rule context="xh:a">
         <assert test="not(descendant::xh:a[@href])"> Don't place links inside other links.</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-mh-periodsAndCommasOutsideLinks-12">
   ...
   <pattern id="schematron-constraint-mh-useProperEllipsis-13">
      <rule context="xh:*[not(self::xh:code or self::xh:pre)][text()]">
         <assert test="not(text()[matches(., '\.\.\.')])"> Use an ellipsis (…) rather than three periods.</assert>
      </rule>
   </pattern>
   <pattern id="schematron-constraint-mh-idShouldMatchFilename-14">
