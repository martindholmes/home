...
<stylesheet xmlns="http://www.w3.org/1999/XSL/Transform"
   ...
   <template match="xh:meta[@content]" mode="group.d4e35" priority="14">
   ...
   <template match="xh:link[@type]" mode="group.d4e35" priority="13">
      <param name="Q{http://dmaus.name/ns/2023/schxslt}pattern"
             as="Q{http://www.w3.org/2001/XMLSchema}string*"
             select="()"/>
      <variable name="Q{http://dmaus.name/ns/2023/schxslt}rule-context"
   ...
   <template match="xh:span" mode="group.d4e35" priority="11">
      <param name="Q{http://dmaus.name/ns/2023/schxslt}pattern"
             as="Q{http://www.w3.org/2001/XMLSchema}string*"
             select="()"/>
      <variable name="Q{http://dmaus.name/ns/2023/schxslt}rule-context"
   ...
   <template match="xh:img" mode="group.d4e35" priority="10">
      <param name="Q{http://dmaus.name/ns/2023/schxslt}pattern"
             as="Q{http://www.w3.org/2001/XMLSchema}string*"
             select="()"/>
      <variable name="Q{http://dmaus.name/ns/2023/schxslt}rule-context"
   ...
   <template match="xh:input[@type='radio']" mode="group.d4e35" priority="9">
      <param name="Q{http://dmaus.name/ns/2023/schxslt}pattern"
             as="Q{http://www.w3.org/2001/XMLSchema}string*"
             select="()"/>
      <variable name="Q{http://dmaus.name/ns/2023/schxslt}rule-context"
                ...
                select="."/>
      <choose>
         <when test="'d4e81' = $Q{http://dmaus.name/ns/2023/schxslt}pattern">
            <svrl:suppressed-rule context="xh:input[@type='radio']">
               <if test="(document-uri(.), base-uri(root()))[1]">
                  <attribute name="document" select="(document-uri(.), base-uri(root()))[1]"/>
               </if>
            </svrl:suppressed-rule>
         ...
         <otherwise>
            <svrl:fired-rule context="xh:input[@type='radio']">
               <if test="(document-uri(.), base-uri(root()))[1]">
                  <attribute name="document" select="(document-uri(.), base-uri(root()))[1]"/>
               </if>
            </svrl:fired-rule>
            ...
            <for-each select=".">
               <choose>
                  <when test="Q{http://www.w3.org/2005/xpath-functions/map}get($Q{http://dmaus.name/ns/2023/schxslt}severity, 'd4e85') ge Q{http://dmaus.name/ns/2023/schxslt}numeric-severity('info')">
                     <if test="not(@name)">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="@name"
                                               patternId="schematron-constraint-radioInputsMustHaveName-6">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
                              <svrl:text> A radio button must have a name attribute.</svrl:text>
                           </svrl:failed-assert>
                        </variable>
                        <sequence select="$failed-assert"/>
                     </if>
            ...
            <next-match>
               <with-param name="Q{http://dmaus.name/ns/2023/schxslt}pattern"
                           as="Q{http://www.w3.org/2001/XMLSchema}string*"
                           select="('d4e81', $Q{http://dmaus.name/ns/2023/schxslt}pattern)"/>
            </next-match>
         </otherwise>
      </choose>
   </template>
                     ...
                     <if test="not(not(text()[matches(., $straightQuotes)]))">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="not(text()[matches(., $straightQuotes)])"
                                               patternId="schematron-constraint-mh-noQuotesInText-7">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
                     ...
                     <if test="not(matches(@src, '^[a-zA-Z0-9/\._\-]+$'))">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="matches(@src, '^[a-zA-Z0-9/\._\-]+$')"
                                               patternId="schematron-constraint-mh-noBadImageFilenames-8">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
                     ...
                     <if test="not(not(text()[not(starts-with(., 'http')) and matches(., '[^\.A-Z]\.[A-Z]')]))">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="not(text()[not(starts-with(., 'http')) and matches(., '[^\.A-Z]\.[A-Z]')])"
                                               patternId="schematron-constraint-mh-spacesAfterPeriods-9">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
                     ...
                     <if test="not(not(text()[matches(., '\.\s*\.\s*\.')]))">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="not(text()[matches(., '\.\s*\.\s*\.')])"
                                               patternId="schematron-constraint-mh-noSpacedPeriodEllipses-10">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
                     ...
                     <if test="not(not(matches(@href, '\s+')))">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="not(matches(@href, '\s+'))"
                                               patternId="schematron-constraint-mh-noSpacesInHrefs-11">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
                     ...
                     <if test="not(not(descendant::xh:a[@href]))">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="not(descendant::xh:a[@href])"
                                               patternId="schematron-constraint-mh-noLinksInLinks-12">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
                     ...
                     <if test="not(not(matches(., '[\.,:;]\s*$')) or matches(., '((Esq\.)|(A\.\s*W\.)|(\.\s*\.\s*\.))$'))">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="not(matches(., '[\.,:;]\s*$')) or matches(., '((Esq\.)|(A\.\s*W\.)|(\.\s*\.\s*\.))$')"
                                               patternId="schematron-constraint-mh-periodsAndCommasOutsideLinks-13">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
   ...
   <template match="xh:*[not(self::xh:code or self::xh:pre)][text()]"
      ...
      <choose>
         ...
         <otherwise>
            ...
            <for-each select=".">
               <choose>
                  <when test="Q{http://www.w3.org/2005/xpath-functions/map}get($Q{http://dmaus.name/ns/2023/schxslt}severity, 'd4e172') ge Q{http://dmaus.name/ns/2023/schxslt}numeric-severity('info')">
                     <if test="not(not(text()[matches(., '\.\.\.')]))">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="not(text()[matches(., '\.\.\.')])"
                                               patternId="schematron-constraint-mh-useProperEllipsis-14">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
   ...
   <template match="xh:article | xh:main | xh:html"
      ...
      <variable name="Q{http://dmaus.name/ns/2023/schxslt}rule-context"
                ...
                select="."/>
      <choose>
         <when test="'d4e177' = $Q{http://dmaus.name/ns/2023/schxslt}pattern">
         ...
         <otherwise>
            ...
            <for-each select=".">
               ...
               <choose>
                  <when test="Q{http://www.w3.org/2005/xpath-functions/map}get($Q{http://dmaus.name/ns/2023/schxslt}severity, 'd4e183') ge Q{http://dmaus.name/ns/2023/schxslt}numeric-severity('info')">
                     <if test="not(matches(document-uri(/), $reFName))">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="matches(document-uri(/), $reFName)"
                                               patternId="schematron-constraint-mh-idShouldMatchFilename-15">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
            ...
            <next-match>
               <with-param name="Q{http://dmaus.name/ns/2023/schxslt}pattern"
                           as="Q{http://www.w3.org/2001/XMLSchema}string*"
                           select="('d4e177', $Q{http://dmaus.name/ns/2023/schxslt}pattern)"/>
            </next-match>
         </otherwise>
      </choose>
   </template>
   ...
   <template match="root()"
      ...
      <try>
         ...
         <svrl:active-pattern id="schematron-constraint-radioInputsMustHaveName-6"/>
         <svrl:active-pattern id="schematron-constraint-schVariables-1"/>
         <svrl:active-pattern id="schematron-constraint-mh-noQuotesInText-7"/>
         <svrl:active-pattern id="schematron-constraint-mh-noBadImageFilenames-8"/>
         <svrl:active-pattern id="schematron-constraint-mh-spacesAfterPeriods-9"/>
         <svrl:active-pattern id="schematron-constraint-mh-noSpacedPeriodEllipses-10"/>
         <svrl:active-pattern id="schematron-constraint-mh-noSpacesInHrefs-11"/>
         <svrl:active-pattern id="schematron-constraint-mh-noLinksInLinks-12"/>
         <svrl:active-pattern id="schematron-constraint-mh-periodsAndCommasOutsideLinks-13"/>
         <svrl:active-pattern id="schematron-constraint-mh-useProperEllipsis-14"/>
         <svrl:active-pattern id="schematron-constraint-mh-idShouldMatchFilename-15"/>
