...
<stylesheet xmlns="http://www.w3.org/1999/XSL/Transform"
                     ...
                     <if test="not(@sizes and xs:string(@sizes) eq 'any')">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="@sizes and xs:string(@sizes) eq 'any'"
                                               patternId="schematron-constraint-linkAttCombos1-1">
                     ...
                     <if test="not(not(@sizes) and not(@type))">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="not(@sizes) and not(@type)"
                                               patternId="schematron-constraint-linkAttCombos2-2">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
                     ...
                     <if test="not(@class or @style or @data-nametype)">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="@class or @style or @data-nametype"
                                               patternId="schematron-constraint-spansMustHaveNametypeStyleOrClass-3">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
                     ...
                     <if test="not(@alt or following-sibling::xh:figcaption)">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="@alt or following-sibling::xh:figcaption"
                                               patternId="schematron-constraint-imgWithoutCaptionNeedsAlt-4">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
   ...
   <template match="xh:*[text()][not(ancestor-or-self::xh:script or ancestor-or-self::xh:style or ancestor-or-self::xh:code or ancestor-or-self::xh:pre)]"
      ...
      <variable name="Q{http://dmaus.name/ns/2023/schxslt}rule-context"
                ...
                select="."/>
      <choose>
         <when test="'d4e85' = $Q{http://dmaus.name/ns/2023/schxslt}pattern">
         ...
         <otherwise>
            ...
            <for-each select=".">
               <choose>
                  <when test="Q{http://www.w3.org/2005/xpath-functions/map}get($Q{http://dmaus.name/ns/2023/schxslt}severity, 'd4e89') ge Q{http://dmaus.name/ns/2023/schxslt}numeric-severity('info')">
                     <if test="not(not(text()[matches(., $straightQuotes)]))">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="not(text()[matches(., $straightQuotes)])"
                                               patternId="schematron-constraint-mh-noQuotesInText-5">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
            ...
            <next-match>
               <with-param name="Q{http://dmaus.name/ns/2023/schxslt}pattern"
                           as="Q{http://www.w3.org/2001/XMLSchema}string*"
                           select="('d4e85', $Q{http://dmaus.name/ns/2023/schxslt}pattern)"/>
            </next-match>
         </otherwise>
      </choose>
   </template>
                     ...
                     <if test="not(matches(@src, '^[a-zA-Z0-9/\._\-]+$'))">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="matches(@src, '^[a-zA-Z0-9/\._\-]+$')"
                                               patternId="schematron-constraint-mh-noBadImageFilenames-6">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
                     ...
                     <if test="not(not(text()[not(starts-with(., 'http')) and matches(., '[^\.A-Z]\.[A-Z]')]))">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="not(text()[not(starts-with(., 'http')) and matches(., '[^\.A-Z]\.[A-Z]')])"
                                               patternId="schematron-constraint-mh-spacesAfterPeriods-7">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
                     ...
                     <if test="not(not(text()[matches(., '\.\s*\.\s*\.')]))">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="not(text()[matches(., '\.\s*\.\s*\.')])"
                                               patternId="schematron-constraint-mh-noSpacedPeriodEllipses-8">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
                     ...
                     <if test="not(not(matches(@href, '\s+')))">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="not(matches(@href, '\s+'))"
                                               patternId="schematron-constraint-mh-noSpacesInHrefs-9">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
                     ...
                     <if test="not(not(descendant::xh:a[@href]))">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="not(descendant::xh:a[@href])"
                                               patternId="schematron-constraint-mh-noLinksInLinks-10">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
                     ...
                     <if test="not(not(matches(., '[\.,:;]\s*$')) or matches(., '((Esq\.)|(A\.\s*W\.)|(\.\s*\.\s*\.))$'))">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="not(matches(., '[\.,:;]\s*$')) or matches(., '((Esq\.)|(A\.\s*W\.)|(\.\s*\.\s*\.))$')"
                                               patternId="schematron-constraint-mh-periodsAndCommasOutsideLinks-11">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
                     ...
                     <if test="not(not(text()[matches(., '\.\.\.')]))">
                        <variable name="failed-assert" as="element(svrl:failed-assert)">
                           <svrl:failed-assert test="not(text()[matches(., '\.\.\.')])"
                                               patternId="schematron-constraint-mh-useProperEllipsis-12">
                              <attribute name="location"
                                         select="path($Q{http://dmaus.name/ns/2023/schxslt}rule-context)"/>
   ...
   <template match="root()"
      ...
      <try>
         <svrl:active-pattern id="schematron-constraint-linkAttCombos1-1"/>
         <svrl:active-pattern id="schematron-constraint-linkAttCombos2-2"/>
         <svrl:active-pattern id="schematron-constraint-spansMustHaveNametypeStyleOrClass-3"/>
         <svrl:active-pattern id="schematron-constraint-imgWithoutCaptionNeedsAlt-4"/>
         <svrl:active-pattern id="schematron-constraint-schVariables-1"/>
         <svrl:active-pattern id="schematron-constraint-mh-noQuotesInText-5"/>
         <svrl:active-pattern id="schematron-constraint-mh-noBadImageFilenames-6"/>
         <svrl:active-pattern id="schematron-constraint-mh-spacesAfterPeriods-7"/>
         <svrl:active-pattern id="schematron-constraint-mh-noSpacedPeriodEllipses-8"/>
         <svrl:active-pattern id="schematron-constraint-mh-noSpacesInHrefs-9"/>
         <svrl:active-pattern id="schematron-constraint-mh-noLinksInLinks-10"/>
         <svrl:active-pattern id="schematron-constraint-mh-periodsAndCommasOutsideLinks-11"/>
         <svrl:active-pattern id="schematron-constraint-mh-useProperEllipsis-12"/>
         <svrl:active-pattern id="schematron-constraint-mh-idShouldMatchFilename-13"/>
